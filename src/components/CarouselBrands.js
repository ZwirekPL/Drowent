    ...
    return (
      <div className="carouselBrands">
        ...
        <Swiper
          ...
          className="brands"
        >
          <SwiperSlide><Brand src={aux} alt="AUX logo" /></SwiperSlide>
          <SwiperSlide><Brand src={daikin} alt="Daikin logo"/></SwiperSlide>
          <SwiperSlide><Brand src={fujitsu} alt="Fujitsu logo"/></SwiperSlide>
          <SwiperSlide><Brand src={gree} alt="Gree logo"/></SwiperSlide>
          <SwiperSlide><Brand src={haier} alt="Haier logo"/></SwiperSlide>
          <SwiperSlide><Brand src={hitachi} alt="Hitachi logo"/></SwiperSlide>
          <SwiperSlide><Brand src={LG} alt="Lg logo"/></SwiperSlide>
          <SwiperSlide><Brand src={kaisai} alt="Kaisai logo"/></SwiperSlide>
          <SwiperSlide><Brand src={mdv} alt="Mdv logo"/></SwiperSlide>
          <SwiperSlide><Brand src={mitsu} alt="Mitsubishi logo"/></SwiperSlide>
          <SwiperSlide><Brand src={serva} alt="Serva logo"/></SwiperSlide>
        </Swiper>
