            ...
            <div className="contactForm__forms">
                <div className="contactForm__sign">
                    ...
                    <div className="contactForm__input">
                        <input type="text" placeholder="Imię" {...register("name", {required: true, max: 15, min: 3, pattern: /"[a-zA-Z]"/i})} />
                        <input type="text" placeholder="Nazwisko" {...register("laName", {required: true, max: 20, min: 1, pattern: /"[a-zA-Z]"/i})} />
                        <input type="email" placeholder="E-mail" {...register("email", {required: true, pattern: /"[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"/i})} />
                        <input type="tel" placeholder="Telefon" {...register("phone", {required: true, max: 9, min: 9, pattern: /"[0-9]{3}"/i})} />
                        ...
                        <select {...register("subject", { required: true })}>
                            <option value="" selected disabled hidden>wybierz wątek</option>
                        ...
                        <textarea placeholder="Wpisz treść zapytania" {...register("text", {required: true, min: 10})} />
                        <input type="submit" />
                    </div>
                    </form>
                </div>
